...
if (in_array($do, ['register', 'doregister', 'login', 'dologin', 'dashboard', 'editprofile', 'saveprofile', 'editpassword', 'savepassword', 'forgotpassword', 'sendpassword', 'deleteprofile', 'dodeleteprofile', 'vieworders', 'vieworder', 'viewmessages', 'viewmessage', 'sendreply', 'logout']))
{
