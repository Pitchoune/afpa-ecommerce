														...
														<polyline style="fill:#FDA589;" points="188.393,349.552 160.785,398.8 137.239,360.959 115.542,400.135 118.951,411.32137.661,377.538 161.162,415.307 195.722,353.66 188.393,349.552" />
														<path style="fill:#CCCCCC;" d="M393.695,417.909l8.485-20.662l25.251,25.251c1.464,1.464,3.387,2.199,5.303,2.192c1.923,0,3.84-0.728,5.303-2.192c2.934-2.934,2.927-7.679,0-10.607l-25.251-25.251l20.669-8.492l-78.559-38.792L393.695,417.909z" />
														<path style="fill:#808080;" d="M393.695,417.909l8.485-20.662l25.251,25.251c1.464,1.464,3.387,2.199,5.303,2.192c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z" />
													</g>
												</svg>
											</div>
										...
										<div class="card tab2-card">
											<div class="card-body">
												<ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" id="top-profile-tab" data-bs-toggle="tab" href="" role="tab" aria-controls="top-profile" aria-selected="true"><span class="icon-user me-2"></span>Login</a>
													</li>
												</ul>
												...
												<div class="card-body">
													...
													if (Utils::cando(5))
													{
														...
														<div class="btn-popup pull-right">
															<a href="index.php?do=addemployee" type="button" class="btn btn-secondary">Ajouter un employé</a>
														</div>
														<?php
													}
													?>
														...
														<div class="tablegrid">
																...
																<table class="tablegrid-table">
																	<thead>
																		<tr class="tablegrid-header-row">
																			<th class="tablegrid-header-cell tablegrid-header-sortable" style="width: 125px">Nom</th>
																			<th class="tablegrid-header-cell tablegrid-header-sortable" style="width: 75px">Prénom</th>
																			<th class="tablegrid-header-cell tablegrid-header-sortable" style="width: 75px">Rôle</th>
																			<?php
																			if (Utils::cando(7) OR Utils::cando(8))
																			{
																				?>
															...
															<div class="tablegrid-grid-body">
																<table class="tablegrid-table">
																	<tbody>
																		<?php
																		// Get the number of employees returned by the model for background lines
																		$quantity = count($employeeslist);

																		foreach ($employeeslist AS $data)
																		{
																			$employees->set_id($data['id']);
																			?>
																			<tr class="<?= (($quantity++ % 2) == 0 ? 'tablegrid-row' : 'tablegrid-alt-row') ?>">
																				...
																				<td class="tablegrid-cell" style="width: 75px"><?=  $data['role'] ?></td>
																				<?php
																				if (Utils::cando(7) OR Utils::cando(8))
																				{
																					?>
																					...
																					{
																						?>
																						<a class="tablegrid-button tablegrid-edit-button" type="button" title="Modifier" href="index.php?do=editemployee&amp;id=<?= $data['id'] ?>"></a>
																						<?php
																					}
																					...
																					if (Utils::cando(8))
																					{
																						...
																						{
																						?>
																							<a class="tablegrid-button tablegrid-delete-button" type="button" title="Supprimer" href="index.php?do=deleteemployee&amp;id=<?= $data['id'] ?>"></a>
																						<?php
																						}
																					}
																					?>
										...
										<div class="col-sm-12">
											<div class="card">
												...
												<div class="card-body">
													...
													?>
													<div class="table-responsive">
														<div class="text-center">Il n'y a pas d'employés.</div>
													</div>
												</div>
											</div>
										</div>
